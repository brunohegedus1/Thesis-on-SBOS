...
\begin{longtable}{p{2.5cm}p{8cm}p{2.5cm}}
    ...
    $M$ & Mach number (Chapter \ref{chapter: Theory}) & [--] \\
    $M$ & Optical magnification of the in-focus plane (Chapter \ref{chapter: methodology} onwards) & [--] \\
    $M_{n}$ & Mach number normal to the shock & [--] \\
    $M_{obj}$ & Blurred object magnification & [--] \\
    $n$ & Refractive index & [--] \\
    $n_o$ & Refractive index of the ambient medium & [--] \\
    $o$ & Interrogation window overlap & [--] \\
    $p$ & Pressure & [Pa] \\
    $Px_{density}$ & Pixel density at the in-focus plane & [px/m] \\
    $Px_{Size}$ & Physical size of one sensor pixel & [m] \\
