...
\begin{longtable}{p{2.5cm}p{8cm}p{2.5cm}}
    ...
    $IW$ & Interrogation window size & [px] \\
    ...
    $M_{ag}$ & Optical magnification of the in-focus plane & [--] \\
    $M_{ag_{obj}}$ & Blurred object magnification & [--] \\
    $n$ & Refractive index & [--] \\
    ...
    $V$ & Velocity & [m/s] \\
    $W_M$ & Mean molecular weight & [kg/mol] \\
