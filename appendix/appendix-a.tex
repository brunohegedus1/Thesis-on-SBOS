...
\par Equation \ref{equation: CoC explicit} can also be modified by substituting it with Eq. \ref{equation: M and S definitions}, which define the magnification $M$ and sensitivity $S$
