...
Substituting equations A.1 in relationship A.2 and doing the necessary simplification, an explicit equation for $CoC$ is obtained:
...
\par In Chapter \ref{chapter: methodology}, the sign of $l$ was considered to change depending on its position relative to the in-focus plane. This way, If an object finds itself behind of the in-focus plane, equation A.3 will result in a negative $CoC$, while if the object is in front, it will be positive. Since the circle of confusion is a length, its absolute value can be considered in these cases.

\par Equation A.3 can also be modified by substituting it with equations A.4, which define the magnification $M$ and sensitivity $S$
...
\begin{align}
    & CoC = \frac{flM}{f_\#m} & CoC = \frac{fS}{f_\#m}
\end{align}
