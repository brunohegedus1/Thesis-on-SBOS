...
\begin{itemize}
    \item Higher focal lengths make the SBOS system more robust to position errors and increases the sensitivity limit for BOS. If size is a constraint, a lower $f$ can result in a more compact setup
