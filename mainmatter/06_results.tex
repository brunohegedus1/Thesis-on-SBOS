...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \label{fig: density field dataset a}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \label{fig: density field dataset b}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \label{fig: density field dataset c}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \label{fig: density field dataset d}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \label{fig: density field dataset f}
    \end{subfigure}
    \caption{Density fields of datasets a to f obtained through the Abel inversion with Tikhonov regularization. The s axis is aligned with the jet axis with its origin at the nozzle exit, while n is normal to it. Datasets a and b use a color scale from 1 to 2.2 kg m$^{-3}$, while datasets c to f use a color scale from 0.5 to 3.1 kg m$^{-3}$. Stations where the Abel inversion returned no value have been cropped}
    \label{fig: density fields}
\end{figure}
