...
To validate the density fields obtained, a similar example from the literature was found that allowed for the direct comparison of the results. Panda and Seasholtz \cite{Panda1999} imaged an underexpanded compressible jet for a series of pressures, corresponding to $M_j$ between 0.99 and 1.8, using a nozzle with $d_N = 25.4$ mm of diameter and published the centerline density of their results. Their case with $M_j = 1.43$ closely resembles the condition of dataset e, where $M_j = 1.435$. The data of Panda and Seasholtz were digitized and plotted together with the centerline density of dataset e for better comparison. Figure \ref{fig: centerline density e vs panda} displays the two graphs. 
