...
The jets in the transition regime between laminar and turbulent jets experience large differences in the boundary layer shape, as investigated by Ozawa et al. \cite{Ozawa2020}. Their figure 12 shows that, for larger Reynolds number (Re = $10^6$), the velocity along the centerline decay faster, while it stays more persistently high at low Reynolds (Re = $10^5$), meaning that Higher Reynolds effects do indeed increase decay downstream. Further literature agrees with these findings. Seiner and Norum \cite{} have reported that the spread of the viscous mixing layer shifts the shock positions predicted by inviscid solutions and weakens the shocks strength further downstream. Moreover, the Hartmann-Lazarus formulation matching this work's data can also be explained by Reynolds equivalence as the range of $M_j$ was similar ($NPR$ around 4) and their nozzle diameter ranged from 4mm to 6mm, yelding a Re $\approx 2.7-4.0 \cdot 10^5$ \cite{Hartmann1941}.
