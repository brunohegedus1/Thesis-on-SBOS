...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Displacement magnitude fields of the compressible jet obtained through cross correlation for gauge pressures from 3 bar to 8 bar with a step of 1 bar. The NPR of each case is shown in its legend. All fields share the same colour scale and masked vectors are shown in grey}
    \label{fig: jet displacement fields}
\end{figure}
