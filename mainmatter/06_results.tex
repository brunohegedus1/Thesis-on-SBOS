...
present the data obtained with the experimental setups described in Section \ref{section: Speckle Pattern Investigation} with the conditions displayed in Tables \ref{tab: speckle investigation matrix} for direct speckles and \ref{tab: projected speckle matrix} for projected speckles. This section will discuss the computed average speckle sizes obtained at each point, the deviation from the Rayleigh limit of equation \ref{equation: Rayleigh Limit} and a quantification of the experiment associated uncertainties.
...
\begin{table}[htbp]
    \centering
    \caption{Speckle sizes measured with directed speckles, for the configurations of Table \ref{tab: speckle investigation matrix}. $M_{ag_{exp}}$ is the magnification measured with the calibration plate, $\Delta s_{th}$ the size predicted by the Rayleigh criterion and $\Delta s_{exp}$ the measured size, reported both by the DaVis estimator and by the one-dimensional autocorrelation method of Hamarová et al. \cite{Hamarova2016}. The last two columns give the deviation of each measurement from the prediction. DaVis returned no value for point 10. Points 1 to 13 vary the aperture and the ground glass distance, whereas points 14 to 28 hold both fixed and sweep the magnification.}
    \label{tab: speckle results direct}
    \begin{tabular}{lrrrrrrrr}
        \toprule
        Point & $f_\#$ & $d_{GG}$ & $M_{ag_{exp}}$ & $\Delta s_{th}$ & \multicolumn{2}{c}{$\Delta s_{exp}$} & \multicolumn{2}{c}{$\Delta s$ dev.} \\
        \cmidrule(lr){6-7} \cmidrule(lr){8-9}
              & [--] & [mm] & [--] & [px] & DaVis & Hamarová & DaVis & Hamarová \\
              &      &      &      &      & [px]  & [px]     & [px]  & [px] \\
        \midrule
         1 &  4.00 &  740 & 0.964 &  0.92 &   1.20 &  1.74 &  $+0.28$ &  $+0.82$ \\
         2 & 11.31 &  740 & 0.964 &  2.59 &   1.48 &  2.73 &  $-1.11$ &  $+0.14$ \\
         3 & 22.63 &  740 & 0.964 &  5.19 &   2.00 &  3.83 &  $-3.19$ &  $-1.36$ \\
         4 &  4.00 &  740 & 0.296 &  0.61 &   1.19 &  1.62 &  $+0.59$ &  $+1.02$ \\
         5 & 11.31 &  740 & 0.296 &  1.71 &   1.56 &  2.71 &  $-0.15$ &  $+1.00$ \\
         6 & 22.63 &  740 & 0.296 &  3.42 &   2.04 &  3.81 &  $-1.39$ &  $+0.39$ \\
         7 & 11.31 &  450 & 0.296 &  1.71 &   1.35 &  2.29 &  $-0.36$ &  $+0.58$ \\
         8 & 11.31 &  280 & 0.296 &  1.71 &   1.40 &  2.45 &  $-0.31$ &  $+0.74$ \\
         9 & 11.31 &  190 & 0.296 &  1.71 &   1.59 &  2.91 &  $-0.12$ &  $+1.20$ \\
        10 & 11.31 &  100 & 0.296 &  1.71 & failed &  4.59 &       -- &  $+2.88$ \\
        11 &  4.00 &  300 & 0.877 &  0.88 &   1.45 &  2.42 &  $+0.57$ &  $+1.54$ \\
        12 & 11.31 &  300 & 0.877 &  2.49 &   1.67 &  2.98 &  $-0.82$ &  $+0.49$ \\
        13 & 22.63 &  300 & 0.877 &  4.97 &   2.41 &  4.15 &  $-2.56$ &  $-0.83$ \\
        \midrule
        14 & 22.63 &  300 & 1.000 &  5.37 &   1.81 &  3.05 &  $-3.57$ &  $-2.33$ \\
        15 & 22.63 &  300 & 0.909 &  5.13 &   1.76 &  3.14 &  $-3.38$ &  $-1.99$ \\
        16 & 22.63 &  300 & 0.800 &  4.84 &   1.86 &  3.26 &  $-2.98$ &  $-1.58$ \\
        17 & 22.63 &  300 & 0.667 &  4.48 &   1.60 &  2.66 &  $-2.88$ &  $-1.81$ \\
        18 & 22.63 &  300 & 0.571 &  4.22 &   1.65 &  2.80 &  $-2.57$ &  $-1.42$ \\
        19 & 22.63 &  300 & 0.500 &  4.03 &   1.47 &  2.39 &  $-2.56$ &  $-1.64$ \\
        20 & 22.63 &  300 & 0.400 &  3.76 &   1.68 &  3.60 &  $-2.08$ &  $-0.16$ \\
        21 & 22.63 &  300 & 0.333 &  3.58 &   1.42 &  2.16 &  $-2.16$ &  $-1.42$ \\
        22 & 22.63 &  300 & 0.286 &  3.46 &   1.48 &  2.38 &  $-1.97$ &  $-1.07$ \\
        23 & 22.63 &  300 & 0.222 &  3.28 &   1.59 &  2.53 &  $-1.70$ &  $-0.76$ \\
        24 & 22.63 &  300 & 0.167 &  3.13 &   1.74 &  2.88 &  $-1.39$ &  $-0.25$ \\
        25 & 22.63 &  300 & 0.118 &  3.00 &   1.91 &  3.06 &  $-1.09$ &  $+0.06$ \\
        26 & 22.63 &  300 & 0.074 &  2.89 &   1.65 &  2.72 &  $-1.23$ &  $-0.17$ \\
        27 & 22.63 &  300 & 0.054 &  2.83 &   1.71 &  2.76 &  $-1.12$ &  $-0.07$ \\
        28 & 22.63 &  300 & 0.035 &  2.78 &   1.87 &  3.09 &  $-0.91$ &  $+0.31$ \\
        \bottomrule
    \end{tabular}
\end{table}

Table \ref{tab: speckle results direct} shows average speckle size obtained experimentally for each point. At a first glance it is already possible to see that the order of magnitude of these results is much similar to the predicted values compared  than the ones obtained previously, in Table \ref{tab: angled glass speckle results}, with deviations that span from 0.07 px to a maximum of 2.88 px. Nevertheless the relative error is still large overall, with the worst result at the points with subpixel speckles and close to 5 px. The error also vastly surpasses the uncertainty associated with magnification, which stayed within 5\% for a 10\% deviation in $M_{ag}$, and post-processing, where the filter uncertainty maximum was XX and the estimator quantified by Hamarová et al. \cite{Hamarova2016} within 1.5\%. Regardless, the data obtained provides a better fit to the Rayleigh diffraction prediction, showing that the equation can be used as a rough preliminary estimator of the speckle size. The results also allows for the identification of useful trends and comparisons in speckle production, as will be shown.

Table \ref{tab: speckle results projected} shows the results of the points obtained with projected speckles. Compared to direct speckles, the projected speckles show a similar deviation to theory and an overall smaller speckle size, which also evident through Figure \ref{fig: speckle f-number sweep}. The results are too similar to the direct speckle approach to discriminate which method to use based on speckle quality. Therefore, the trade-off on how to create the speckle pattern comes more to practical considerations than on its speckle characteristics. Projected speckles might be preferable in applications where only one optical access is available; where powerful lasers are being used that could damage the camera or when the double-pass method of Meier \& Rösgen \cite{Meier&Roesgen2013} needs to be used for increased sensitivity, but it might be more vulnerable to vibrations and decorrelation \cite{Buhlmann2020}. Whereas direct speckle provides more intensity, which allows for lower exposures; is more robust against vibrations and decorrelation; and might be preferable when a see-through optical access is available.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lrrrrrrrr}
        ...
        \cmidrule(lr){6-7} \cmidrule(lr){8-9}
              ...
              &      &      &      &      & [px]  & [px]     & [px]  & [px] \\
        \midrule
        29 &  4.00 &  300 & 0.457 &  0.67 &   1.22 &  1.59 &  $+0.55$ &  $+0.92$ \\
        30 & 11.31 &  300 & 0.457 &  1.90 &   1.44 &  2.21 &  $-0.46$ &  $+0.31$ \\
        31 & 22.63 &  300 & 0.457 &  3.81 &   2.09 &  3.61 &  $-1.72$ &  $-0.20$ \\
        \bottomrule
    \end{tabular}
\end{table}

%Talk about the uncertainty quantification

The various $f_\#$ sweeps made during the experimental campaign allows to evaluate if the interference waves became diffraction limited at the pupil. Figure \ref{fig: speckle f-number sweep} shows the trend of average speckle size with f-stop number for 4 different configurations. All lines follow the characteristic increasing trend of a developed subjective speckle, which follows equation \ref{equation: Rayleigh Limit}, and signals that the interference front is becoming diffraction limited at the lens pupil \cite{Goodman2020}. The red and yellow lines both share the same $d_{GG}$ what makes them viable for direct comparison. Curiously, it appears that the increased magnification of the red line caused practically no effect in the average speckle size, displaying almost the same values for equal f-stop as the yellow line. The same insensitivity to magnification was also experienced through points 14-28 which will be treated later. Looking at the purple line compared to the latter two, it appears that the different $d_{GG}$ introduced some difference in the speckle size, with the purple exceeding the red by 0.7, 0.25 and 0.33 px for $f_\#$ 4,11,22 respectively. In green, the projected speckle trend can also be analyzed. It demonstrates that projected speckles are generally smaller, presenting smaller speckles even to yellow which has a lower magnification than green. The Figure shows some promising trends as there is a clear dependence on $f_\#$ and it indicates a tendency of projected to be smaller than direct speckles. However, it also shows an insensitivity to the optical magnification, contradicting equation \ref{equation: Rayleigh Limit}, and the effect of $d_{GG}$ which will be further discussed next.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/speckle exp f-number sweep.jpg}
...
It is possible to verify the influence of the beam diameter in the speckle generation by plotting the points where only $d_{GG}$ was varied. Figure \ref{fig: speckle dGG sweep} shows that the average speckle size remains quite consistent for high $d_{GG}$, as it varies from 2.91 px at 190mm, dips to 2.29 px at 450 mm and goes to 2.71 px at 740mm. This variation is consistent with the findings of Figure \ref{fig: speckle f-number sweep}. It shows that $d_{GG}$ can increase the speckle size but for large distances the spread is practically subpixel. However, the figure also shows a spike at low $d_{GG}$ when the beam diameter is small, reaching 4.59 px at 100mm with beam ratio of 1.25. This data supports the hypothesis that the larger speckle size in the angled glass experiment was caused by the small diameter of the laser when it hit the 12.7cm ground glass diffuser. The fact that the speckle changed less for larger distances is also backed up by the literature, which doesn't mention the effect of the laser diameter in the speckle generation. In addition, it means that, when designing the laser optical setup, an experimentalist must only worry about expanding the laser beam to fill the desired field of view.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/Speckle d_GG Sweep.jpg}
