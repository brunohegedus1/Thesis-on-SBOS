...
The 5 plots of Figure \ref{fig: density fields jets} give a more intuitive visualization of the trends in the jet than the density gradient. It is now clearer to identify the position of a shock as a large increase in density in a very small space. For example on dataset f, density increases from below 1 in the shock cell core to above 2 in a space of less than 2mm at around s = 5mm. Comparing the images with the density gradient centerlines of Figure \ref{fig: centerline density gradients}, it is possible to verify that the prescribed regions of maxima and minima of density do indeed match the markings.
