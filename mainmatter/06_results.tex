...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Centerline density gradient in the s direction for datasets a to f, obtained assuming a planar field. The light blue line is the gradient at the axis row $n = 0$ and the dark blue line its mean over $|n| \leq 0.25$ mm. The markers indicate the compression peaks, expansion troughs, density minima and density maxima detected along the centerline, and the dashed line marks the end of the first shock cell}
