...
\begin{table}[h]
    \centering
    \caption{Uncertainty budget for the displacement measured by cross-correlation and sensitivity. The scatter of the vector field is evaluated from the data of Table \ref{tab: angled glass displacement results} and varies per point, here the range of values is displayed. The magnification residual slightly varies per point but the maximum was taken here. The pixel pitch is common to the whole campaign. The combined row applies to the measured displacement alone. The totals that also carry the prediction budget of Table \ref{tab: angled glass uncertainty} are given at the bottom of Tables \ref{tab: angled glass displacement results} and \ref{tab: sensitivity comparison}.}
