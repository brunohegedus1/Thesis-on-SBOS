...
\begin{figure}[htbp]
    ...
    \caption{First shock cell length $L_s$ of datasets a to f, normalized by the jet diameter, against $\sqrt{NPR - NPR_c}$. The measurements are displayed together with the formulations of Emden ($k = 0.88$) and Hartmann-Lazarus ($a = 0.98$, $b = 0.30$) and with the curves of both formats fitted to the data}
