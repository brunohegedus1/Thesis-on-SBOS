...
3 points were obtained using projected speckles and they are summarized in Table \ref{} as points 29-31. A $f_\#$ sweep was done to assess the effect of that variable with a $d_{GG}$ of 300mm, as it was the distance where the most amount of points were collected for the directed speckle case. Therefore, a direct comparison can be done between the results obtained with projected speckles and direct speckles.
